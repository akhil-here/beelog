        ...
        <div class="col-6 text-white d-flex min-vh-100 align-items-center justify-content-center flex-column">
            <form method="POST" class="w-75">
                ...
                <div class="form-group">
                    <h1 class="font-weight-bold py-4">Login
                    </h1>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <a href="register.php" class="text-white d-block mt-4">Register
                    </a>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-success shadow my-4">Proceed
                    </button>
                </div>
                <div class="form-group">
                    <?php
